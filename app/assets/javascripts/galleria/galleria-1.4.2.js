...
// internal constants
    ...
    _video = {
        youtube: {
            ...
            getUrl: function() {
                return PROT + "//www.googleapis.com/youtube/v3/videos?id="+ this.id +"&part=contentDetails&key=AIzaSyABHvS1T-esKmEvyURSTDqMaGSiR1ucKE0&callback=?";
            },
            get_thumb: function(data) {
                PROT + '//img.youtube.com/vi/'+data.items[0].id+'/maxresdefault.jpg';
            },
    ...
    */
    ...
    destroy : function() {
        ...
        if ( Galleria._waiters != undefined && Galleria._waiters.length ) {
            ...
            console.log('Galleria error: Galleria._waiters is ' + Galleria._waiters)
        }
        return this;
    },
...
Galleria.Picture.prototype = {
    ...
    */
    ...
    load: function(src, size, callback) {
        ...
        // https://support.galleria.io/discussions/problems/12245-shaking-photos
