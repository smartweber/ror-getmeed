...
skills_hist = Hash[Final_skills.group_by{|v| v}.map{|k, v| [k, v.size]}];

skills_hist = skills_hist.sort_by{|k,v| -v};

skills_hist.each do |k,v|
  puts "#{k}\t#{v}"
end
